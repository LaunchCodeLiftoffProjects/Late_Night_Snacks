...
{
    public class MenuItemDatabaseInitializer 
    {
        public static void Seed(MenuItemsContext context)
        {
            context.Database.EnsureDeleted();
            context.Database.EnsureCreated();
            GetCategories().ForEach(c => context.Categories.Add(c));
            GetMenuItems().ForEach(p => context.MenuItems.Add(p));
        }
